...
bool ArchiJavaFxRuntime::tryOpenWindow(std::string title, Arguments arguments) { return impl_->tryOpenWindow(std::move(title), std::move(arguments)); }
bool ArchiJavaFxRuntime::tryOpenModalWindow(std::string title, Arguments arguments) { return impl_->tryOpenModalWindow(std::move(title), std::move(arguments)); }
