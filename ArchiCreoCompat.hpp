...
namespace creo::detail {
    ...
    inline ProErrorCode arrayAlloc(int n_objs, int obj_size, int reallocation_size, RawArray* p_array) {
    ...
    inline ProErrorCode sessionMdlList(RawMdlType model_type, RawMdl** p_model_array, int* p_count) {
        return ::ProSessionMdlList(model_type, p_model_array, p_count);
    }
    inline ProErrorCode mdlSave(RawMdl model) {
        return ::ProMdlSave(model);
    }
    inline ProErrorCode mdlnameRename(RawMdl model, wchar_t* new_name) {
        return ::ProMdlnameRename(model, new_name);
    }
    inline ProErrorCode mdlModificationVerify(RawMdl model, RawBoolean* p_modified) {
        return ::ProMdlModificationVerify(model, p_modified);
    }
    inline ProErrorCode solidMdlnameCreate(RawMdlName name, RawMdlFileType type, RawSolid* p_handle) {
        return ::ProSolidMdlnameCreate(name, type, p_handle);
    }
    inline ProErrorCode solidRegenerate(RawSolid solid, int flags) {
    ...
    inline ProErrorCode windowMdlGet(int window_id, RawMdl* p_mdl) {
        return ::ProWindowMdlGet(window_id, p_mdl);
    }
    inline ProErrorCode windowNameGet(int window_id, char** p_window_name) {
        return ::ProWindowNameGet(window_id, p_window_name);
    }
    ...
    inline ProErrorCode objectwindowMdlnameCreate(wchar_t* object_name, RawObjectType object_type, int* p_window_id) {
        return ::ProObjectwindowMdlnameCreate(object_name, object_type, p_window_id);
    }
    inline ProErrorCode configoptionGet(wchar_t* option, wchar_t* option_value) {
        return ::ProConfigoptionGet(option, option_value);
    }
    inline ProErrorCode configoptSet(wchar_t* option, wchar_t* option_value) {
        return ::ProConfigoptSet(option, option_value);
    }
    inline ProErrorCode engineerConnectIdGet(char* connect_id) {
